...
class BlogAR extends BaseAR
{
	...
	public function rules()
	{
		...
		return array(
			...
			*/
			array('name, content, alias, created, description', 'required', 'message' => 'Please input {attribute}'),
			...
			array('description, order, status, selected, lang', 'safe')
		);
	}
