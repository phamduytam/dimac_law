...
<div class="row">
<ol class="breadcrumb">
	<li><i class="fa fa-star-o"></i> <a href='<?php echo $this->baseUrl?>/baiviet?cat_id=<?php echo $cat_id?>'><?php echo $this->pageTitle?></a></li>
...
<?php
	$form = $this->beginWidget('TbActiveForm', array(
		'action'=>sslUrl($this->baseUrl.'baiviet/add?cat_id='.$_GET['cat_id']),
		'id' => 'add-form',
