...
<div class="row">
<ol class="breadcrumb">
	<li><i class="fa fa-star-o"></i> <a href='<?php echo url($this->baseUrl.'baiviet?cat_id='.$model->cat_id)?>'><?php echo $this->pageTitle?></a></li>
...
<?php
	$form = $this->beginWidget('TbActiveForm', array(
		'action'=>sslUrl($this->baseUrl.'baiviet/edit/'.$model->id.'?cat_id='.$model->cat_id),
		'id' => 'add-form',
...
<div class="form-group">
	...
	<script>
	editor = CKEDITOR.replace( 'BaiVietAR_content', {
