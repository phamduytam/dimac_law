...
<ol class="breadcrumb">
	...
	<li><a href='<?php echo url($this->baseUrl.'chucdanh')?>'><?php echo $this->pageTitle;?></a></li>
	<li>Add</li>
</ol>
	...
	<div class="col-lg-8">
		...
		<?php
			$form = $this->beginWidget('TbActiveForm', array(
				'action'=>sslUrl($this->baseUrl.'chucdanh/add'),
				'id' => 'add-form',
		...
		<div class="form-group">
			...
			<?php echo $form->textField($model,'name', array('class' => 'form-control', 'placeholder' => 'Vui lòng nhập chức danh ')); ?>
		</div>
