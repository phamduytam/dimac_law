...
<div class="table-responsive">
	<div class="row">
		<div class="col-lg-6">
			<form method="get" id="form" action="<?php echo url($this->baseUrl.'room')?>">
		...
		<div class="col-lg-3 pull-right">
			<p class="text-right">
				<a href="<?php echo url($this->baseUrl.'room/add')?>"><button class="btn btn-primary" type="button">Add</button></a>
			</p>
		</div><!-- /input-group -->
	</div>
	<!-- table -->
