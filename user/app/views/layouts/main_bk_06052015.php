		...
		<div class="container">
			...
			<div class="fright">
				<div class="lang visible-lg">
					<a href="#">English</a><span style="padding:0 13px">|</span><a href="<?php echo url('vn')?>">Vietnamese</a><span style="padding:0 13px">|</span><a href="<?php echo url($this->baseUrl.'lien-he.html')?>" class="lienhe">Liên hệ</a>
				</div>
				<div class="lang_mobile hidden-lg"><a href="#">English</a> | <a href="<?php echo url('vn')?>">Vietnamese</a> | <a href="<?php echo url($this->baseUrl.'lien-he.html')?>" class="lienhe">Liên hệ</a></div>
	...
	<div class="container">
		<!-- // Mobile menu trigger // -->
			...
			<ul class="sf-menu" id="menu">
				...
				<li><a href="<?php echo url($this->baseUrl.'gioi-thieu.html')?>" style="padding-left: 5px;">Giới Thiệu</a>
					<?php if(isset($menu['gioithieu']) && !empty($menu['gioithieu'])):?>
					<ul>
						<?php foreach ($menu['gioithieu'] as $v):?>
						<?php if($v->alias == 'doi-tac-kinh-doanh'):?>
										<li>
											<a href="<?php echo url('luat-su.html')?>" title="Luật sư">
												Luật sư
											</a>
										</li>
									<?php endif;?>
