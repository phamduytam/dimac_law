...
<ol class="breadcrumb">
	<li class="active"><i class="fa fa-life-ring"></i> <a>Trang đơn</a></li>
</ol>
<div class="table-responsive">
<div class="row">
	<div class="col-lg-6">
		<form method="get" id="form" action="/admin/static">
	...
	<div class="col-lg-3 pull-right">
		<p class="text-right">
			<a href="<?php echo url('static/add')?>"><button class="btn btn-primary" type="button">Add</button></a>
		</p>
	</div><!-- /input-group -->
</div><!-- /.col-lg-6 -->
</div>
